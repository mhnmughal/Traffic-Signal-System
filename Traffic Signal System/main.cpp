...
void rules_screen(void){
    ...
    glClear(GL_COLOR_BUFFER_BIT);
    glColor3f(1,0,0);
    drawstring(-10.0,15.0,0.0,"<Your Institute>");
...
glColor3f(1,0.5,0);
drawstring(-4,4,0.0,"Implimented By: <Your Name>");
glColor3f(0.1333333f,0.5450980392f,0.133333333f);
drawstring(-6.50,1,0.0,"Name:<Your Name>");
...
void display1(){
    ...
    glColor3f(0.7,0,1);
    drawstring(-15.0,8.90,0.0,"UniversityXXX");
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow ("Traffic signal created by <Your Name>");
